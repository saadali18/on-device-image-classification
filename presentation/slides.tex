  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.50\textwidth}
      ...
      \begin{itemize}\small
        ...
        \item \textbf{Knowledge Distillation}: train a compact \emph{student} to mimic a large pretrained \emph{teacher}
      \end{itemize}
      \vspace{0.35em}
      \textbf{Hard labels discard inter-class similarity}
      \begin{itemize}\small
...
\begin{frame}{Dark Knowledge \& Calibration Analysis}
  \begin{columns}[t]
    ...
    \begin{column}{0.52\textwidth}
      ...
      {\footnotesize Each row: image $|$ teacher $T{=}1$ $|$ teacher $T{=}4$ $|$ hard-label student $|$ distilled student.
      At $T{=}4$, probability spreads to similar classes; distilled student mimics this structure while hard-label student does not.}
    \end{column}
    % ---- right: calibration ----
